...
city_4_name = 'Mumbai'
city_4_population = 12480000
city_4_unemployment_rate = 1
...
if city_4_population > city_2_population:
    result = city_4_name + ' is bigger than ' + city_2_name
    print(result)
...
if city_4_unemployment_rate == city_3_unemployment_rate:
    result = city_1_name + ' has the same unemployment rate than ' + city_3_name
elif city_4_unemployment_rate < city_3_unemployment_rate:
    result = city_4_name + ' has a lower unemployment rate than ' + city_3_name
else:
    result = city_4_name + ' has a higher unemployment rate than ' + city_3_name
print(result)
...
if city_4_population > city_2_population:
    if city_4_unemployment_rate > city_2_unemployment_rate:
        result = city_4_name + ' is bigger and has a higher unemployment rate than ' + city_2_name
    else:
        result = city_4_name + ' is bigger but has a lower unemployment rate than ' + city_2_name
else:
    if city_4_unemployment_rate > city_2_unemployment_rate:
        result = city_2_name + ' is bigger and has a higher unemployment rate than ' + city_4_name
    else:
        result = city_2_name + ' is bigger but has a lower unemployment rate than ' + city_4_name
print(result)
